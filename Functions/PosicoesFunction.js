...
function Posicao1(interaction, client) {
    ...
    const embed = new EmbedBuilder()
        ...
        .setDescription(`Coloque Abaixo o Valor e o Cargo Ex: Cliente Gastou 50 Reais Que é a Primeira Colocação, Ele Irá Receber o Cargo Configurado Da 1 Colocação.`)
        .addFields(
